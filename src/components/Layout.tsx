...
import { CalendarDays, PlusCircle, Wallet, TrendingUp, BarChart3, LogOut, BarChart2, DollarSign, Users, Ban, CalendarClock } from 'lucide-react'
...
const nav = [
  ...
  { to: '/calendario', icon: CalendarClock, label: 'Calendario (piloto)' },
