export interface Servicio {
  ...
  duracion: number
  precio: string
  precioEditable?: boolean // precio se define en valoración (ej: servicios de color)
...
export const SERVICIOS: Record<string, Servicio[]> = {
  ...
  "Manicure": [
    { nombre: "Manos Semipermanente",               calendarId: "EDiqwAb54xY6nID5yzB8", duracion: 75,  precio: "$60.000",  profesionales: NAILS },
    { nombre: "Manos Tradicional",                  calendarId: "ItIbYfgFYYvZYQ6Oje0B", duracion: 60,  precio: "$45.000",  profesionales: NAILS },
    { nombre: "Manos Evolution",                    calendarId: "uyBy6KxStea3tyJXkxvE", duracion: 60,  precio: "$40.000",  profesionales: NAILS },
    { nombre: "Builder Gel",                        calendarId: "58aCvkqxbMBcFFPgZmyk", duracion: 120, precio: "$85.000",  profesionales: NAILS },
    { nombre: "Baby Boomer",                        calendarId: "HhrSGv6kTKZOtLwLtLaO", duracion: 170, precio: "$160.000", profesionales: NAILS },
    { nombre: "Base Rubber Manos",                  calendarId: "yVTJ5MuqOiTIG6aW4Zzu", duracion: 75,  precio: "$85.000",  profesionales: NAILS },
    ...
    { nombre: "Retoque Esculpidas Polygel/Acrílico",calendarId: "JuHPG8vMNXKSOiyVNzjR", duracion: 120, precio: "$100.000", profesionales: NAILS },
    { nombre: "Retoque Recubrimiento Poly/Acrílico",calendarId: "g7a3uGcoBdAdrffowsY1", duracion: 100, precio: "$90.000",  profesionales: NAILS },
    { nombre: "Uñas Dip Powder + Semipermanente",   calendarId: "DIDIge2ItuyDQU3hfjqA", duracion: 70,  precio: "$85.000",  profesionales: NAILS },
    { nombre: "Uñas Press On",                      calendarId: "CwNB6YUweNhSrYOTFElB", duracion: 120, precio: "$100.000", profesionales: NAILS },
    { nombre: "Retoque Press On",                   calendarId: "rSP0C1qAAvA82qSGwSsz", duracion: 120,  precio: "$85.000",  profesionales: NAILS },
    { nombre: "Esmaltado Semipermanente Manos",     calendarId: "UdfCTzTMPNhYuemDnWsb", duracion: 20,  precio: "$40.000",  profesionales: NAILS },
    { nombre: "Esmaltado Tradicional Manos",        calendarId: "54RoAHSPDVzWjfk4N2cR", duracion: 30,  precio: "$25.000",  profesionales: NAILS },
    { nombre: "Retiro Semipermanente Manos",        calendarId: "CUY39YrfaRmiHvMdGTol", duracion: 30,  precio: "$15.000",  profesionales: NAILS },
    { nombre: "Retiro Rubber/Dipping",              calendarId: "KDdZgv19rQYsaxXNeIMB", duracion: 30,  precio: "$25.000",  profesionales: NAILS },
    { nombre: "Retiro Polygel/Acrílico",            calendarId: "NbDO7tF3rTsVlsNAqweR", duracion: 30,  precio: "$25.000",  profesionales: NAILS },
    { nombre: "Limpieza Manos",                     calendarId: "yENMASOfLO8JTFgjW23z", duracion: 30,  precio: "$25.000",  profesionales: NAILS },
    { nombre: "Masaje Relajante de Manos",          calendarId: "74JOMcKwGJTEqfgqo2Ra", duracion: 7,   precio: "$25.000",  profesionales: NAILS },
    { nombre: "Diseño",                             calendarId: "ZIeJPQLAeo3bM3tLDL8z", duracion: 10,  precio: "$0",       profesionales: NAILS },
  ...
  "Pedicure": [
    { nombre: "Pies Semipermanente",            calendarId: "szaDqVWMTKAFCVcYjgTh", duracion: 75, precio: "$60.000",  profesionales: NAILS },
    { nombre: "Pedicura Tradicional + Pedi Spa",calendarId: "MPv75km6l8sal1NKHqtV", duracion: 60, precio: "$85.000",  profesionales: NAILS },
    { nombre: "Pedicura Semi + Pedi Spa",       calendarId: "1OpkJJuQoNlATF5hd9Zi", duracion: 70, precio: "$105.000", profesionales: NAILS },
    { nombre: "Pies Evolution",                 calendarId: "tKn5Hy3A7pKqg7nhVpgC", duracion: 60, precio: "$45.000",  profesionales: NAILS },
    { nombre: "Tradicional Pies",               calendarId: "XbxF4HF4VH3KNB16sNBU", duracion: 60, precio: "$40.000",  profesionales: NAILS },
    { nombre: "Retiro Semipermanente Pies",     calendarId: "FJDuHD0L2DqBLPUeYsqM", duracion: 30, precio: "$15.000",  profesionales: NAILS },
  ...
  "Manicura y Pedicura": [
    ...
    { nombre: "Uñas Esmaltado Tradicional (Manos y Pies)", calendarId: "OYVNrcCxrbSYEd1SbV3f", duracion: 100, precio: "$75.000",  profesionales: NAILS },
    { nombre: "Manos Semipermanente y Pies Evo",           calendarId: "z6VLaBzxm2hxO4JglzOI", duracion: 120, precio: "$105.000", profesionales: NAILS },
    { nombre: "Evolution (Manos y Pies)",                  calendarId: "ZLEVvENlOAsJdUVyyLGf", duracion: 80,  precio: "$85.000",  profesionales: NAILS },
    { nombre: "Manos Tradicionales + Pies Semipermanente", calendarId: "iAOrgphopFSqRQt5dxTm", duracion: 120, precio: "$95.000",  profesionales: NAILS },
    { nombre: "Solo Limpieza Manos y Pies",                calendarId: "FMTaDks9JBTh1hXZ9k2U", duracion: 60,  precio: "$50.000",  profesionales: NAILS },
  ...
  "Cabello": [
    ...
    { nombre: "Alisado Natural Argán y Coco (Corto)",       calendarId: "tYgB9RKWsWnAY6yzHbzo", duracion: 300, precio: "$250.000", precioEditable: true, profesionales: [LS] },
    ...
    { nombre: "Planchado de Cabello",                       calendarId: "eSmQWFTgnrsIhICBidoF", duracion: 40,  precio: "$50.000",  profesionales: [LS] },
    { nombre: "Ondas",                                      calendarId: "pyw2lCLu7OmMz5i1Xj0i", duracion: 45,  precio: "$70.000",  profesionales: [LS] },
    ...
    { nombre: "Terapia Capilar de L'Oréal",                 calendarId: "gJhd4efPJ7Zs7Ogybq95", duracion: 20,  precio: "$120.000", profesionales: [LS] },
    { nombre: "Terapia Capilar Authentic",                  calendarId: "",                       duracion: 60,  precio: "$250.000", profesionales: HAIR },
    { nombre: "Toxina Botulínica",                          calendarId: "7G42EdlizK39sGWSRTWO", duracion: 20,  precio: "$0",       profesionales: [LS] },
  ...
  "Cejas y Pestañas": [
    ...
    { nombre: "Extensión de Pestañas Efecto Clásica",     calendarId: "dry2VkC24zeouSdN4VEm", duracion: 70, precio: "$160.000", profesionales: [LS] },
    { nombre: "Extensión de Pestañas Efecto Híbrido",     calendarId: "dbxPJAla6tTHNv73eo1l", duracion: 90, precio: "$180.000", profesionales: [LS] },
    { nombre: "Extensión de Pestañas Efecto Tecnológico", calendarId: "4O1RVMdKaXEUaHqQqVP1", duracion: 90, precio: "$200.000", profesionales: [LS] },
    { nombre: "Retoque Pestañas",                         calendarId: "yuikssBrbkVHsArQoe65", duracion: 60, precio: "$80.000",  profesionales: [LS] },
  ...
  "Depilación": [
    { nombre: "Depilación Pierna Completa",          calendarId: "cmyFlDKVr8UemAn9N71W", duracion: 90, precio: "$100.000", profesionales: [LS] },
    { nombre: "Depilación Media Pierna",             calendarId: "eRj3f8o8CLcD7i0rIgm3", duracion: 60, precio: "$50.000",  profesionales: [LS] },
    { nombre: "Depilación Línea del Bikini",         calendarId: "mfXJuW1bdCIPV4GgCSx3", duracion: 45, precio: "$45.000",  profesionales: [LS] },
    { nombre: "Depilación de Pubis Completo",        calendarId: "1vn5jyzI6R8TstZCZhOI", duracion: 60, precio: "$80.000",  profesionales: [LS] },
    { nombre: "Depilación de Axilas",                calendarId: "mSw9Swdz68i0hC5cqNme", duracion: 18, precio: "$35.000",  profesionales: [LS] },
    { nombre: "Depilación Espalda Baja",             calendarId: "9HqMBn6P9DBAsMqZmFit", duracion: 60, precio: "$50.000",  profesionales: [LS] },
    { nombre: "Depilación de Glúteos",               calendarId: "woQv67dSOZkRipYxGaXm", duracion: 20, precio: "$35.000",  profesionales: [LS] },
    { nombre: "Depilación Bigote",                   calendarId: "UKZG99bvj0QCeFJaLNk7", duracion: 10, precio: "$20.000",  profesionales: [LS] },
    { nombre: "Depilación Bigote con Hilo",          calendarId: "eHXH3nwnTLLoacCnQKeh", duracion: 10, precio: "$25.000",  profesionales: [LS] },
    { nombre: "Depilación Barbilla con Hilo",        calendarId: "9M1FFJKZmz9tPhwEitAb", duracion: 10, precio: "$20.000",  profesionales: [LS] },
    { nombre: "Depilación Orejas",                   calendarId: "whI104AHCNJGaV35yii2", duracion: 20, precio: "$20.000",  profesionales: [LS] },
    { nombre: "Depilación Nariz",                    calendarId: "ZdfgP31Jmj4hWCEezhda", duracion: 20, precio: "$20.000",  profesionales: [LS] },
  ...
  "Maquillaje Profesional": [
    ...
    { nombre: "Baño de Novia Brazos", calendarId: "OybBhb6gij304Vromp7n", duracion: 15, precio: "$30.000",  profesionales: [LS] },
  ],
...
export const PROFESIONALES: Profesional[] = [
  ...
  { nombre: "Zuly Rojas",     userId: ZR, especialidad: "Uñas & Manicure",   iniciales: "ZR", foto: "/fotos/zuly.jpg" },
