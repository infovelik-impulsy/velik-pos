...
export const SERVICIOS: Record<string, Servicio[]> = {
  ...
  "Manicure": [
    ...
    { nombre: "Manos Tradicional",                  calendarId: "ItIbYfgFYYvZYQ6Oje0B", duracion: 60,  precio: "$35.000",  profesionales: NAILS },
    ...
    { nombre: "Base Rubber Manos",                  calendarId: "yVTJ5MuqOiTIG6aW4Zzu", duracion: 80,  precio: "$85.000",  profesionales: NAILS },
    ...
    { nombre: "Retoque Recubrimiento Poly/Acrílico",calendarId: "g7a3uGcoBdAdrffowsY1", duracion: 120, precio: "$90.000",  profesionales: NAILS },
  ...
  "Manicura y Pedicura": [
    ...
    { nombre: "Uñas Esmaltado Tradicional (Manos y Pies)", calendarId: "OYVNrcCxrbSYEd1SbV3f", duracion: 100, precio: "$60.000",  profesionales: NAILS },
  ...
  "Depilación": [
    ...
    { nombre: "Depilación de Axilas",                calendarId: "mSw9Swdz68i0hC5cqNme", duracion: 18, precio: "$30.000",  profesionales: HAIR },
