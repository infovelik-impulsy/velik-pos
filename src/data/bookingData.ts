...
export const SERVICIOS: Record<string, Servicio[]> = {
  ...
  "Manicure": [
    ...
    { nombre: "Manos Evolution",                    calendarId: "uyBy6KxStea3tyJXkxvE", duracion: 45,  precio: "$40.000",  profesionales: NAILS },
    ...
    { nombre: "Retoque Esculpidas Polygel/Acrílico",calendarId: "JuHPG8vMNXKSOiyVNzjR", duracion: 110, precio: "$100.000", profesionales: NAILS },
    ...
    { nombre: "Uñas Press On",                      calendarId: "CwNB6YUweNhSrYOTFElB", duracion: 90,  precio: "$100.000", profesionales: NAILS },
    { nombre: "Retoque Press On",                   calendarId: "rSP0C1qAAvA82qSGwSsz", duracion: 80,  precio: "$85.000",  profesionales: NAILS },
  ...
  "Pedicure": [
    ...
    { nombre: "Retiro Semipermanente Pies",     calendarId: "FJDuHD0L2DqBLPUeYsqM", duracion: 20, precio: "$15.000",  profesionales: NAILS },
  ...
  "Cejas y Pestañas": [
    ...
    { nombre: "Extensión de Pestañas Efecto Clásica",     calendarId: "dry2VkC24zeouSdN4VEm", duracion: 70, precio: "$160.000", profesionales: [LV] },
    { nombre: "Extensión de Pestañas Efecto Híbrido",     calendarId: "dbxPJAla6tTHNv73eo1l", duracion: 90, precio: "$180.000", profesionales: [LV] },
    { nombre: "Extensión de Pestañas Efecto Tecnológico", calendarId: "4O1RVMdKaXEUaHqQqVP1", duracion: 90, precio: "$200.000", profesionales: [LV] },
    { nombre: "Retoque Pestañas",                         calendarId: "yuikssBrbkVHsArQoe65", duracion: 60, precio: "$80.000",  profesionales: [LV] },
  ...
  "Corporal": [
    ...
    { nombre: "Masaje Relajación Piedras Volcánicas + Velas",calendarId: "q2Iz4gfTyoB3JkRNZ4CZ", duracion: 60,  precio: "$140.000",   profesionales: [LV, LA] },
