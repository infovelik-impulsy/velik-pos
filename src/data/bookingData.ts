...
export const SERVICIOS: Record<string, Servicio[]> = {
  ...
  "Pedicure": [
    ...
    { nombre: "Pies Evolution",                 calendarId: "tKn5Hy3A7pKqg7nhVpgC", duracion: 40, precio: "$45.000",  profesionales: NAILS },
    { nombre: "Tradicional Pies",               calendarId: "XbxF4HF4VH3KNB16sNBU", duracion: 45, precio: "$40.000",  profesionales: NAILS },
